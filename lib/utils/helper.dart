...
List<Video> getFakeVideos() {
  return [
    ...
    Video(
        ...
        description:
            "Fire Rhythm, a Los Angeles dance team, is rising in the elite ranks of fire dancing. Thisrequired video captured their astounding performance at the Orange Valley Contemporary Arts Museum.",
        thumbnail:
